...
{% video %}http://ovwbdgz95.bkt.clouddn.com/react-fundamental-3stateManagement-5-1.mp4{% endvideo %}
下面我们看一下具体怎么通过setState函数来修改state
{% video %}http://ovwbdgz95.bkt.clouddn.com/react-fundamental-3stateManagement-5-2.mp4{% endvideo %}
